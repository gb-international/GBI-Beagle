...
class ChequePaymentRequest extends FormRequest
{
    ...
    public function rules()
    {
        ...
        return [
            ...
            'incharge_edu_institute_id' =>(($client_type == "user" && $tour_type == "school")) ? 'required|exists:edu_institutes,id' : '',
            'incharge_company_user_id' =>(($client_type == "user" && $tour_type == "company")) ? 'required|exists:company_users,id' : '',
            'incharge_family_user_id' =>(($client_type == "user" && $tour_type == "family")) ? 'required|exists:family_users,id' : '',
