...
{
    protected $fillable = [
        'tour_id','travel_code','itinerary_id','school_id', 'company_id', 'customer_type','tour_start_date','tour_end_date','tour_price','status','payment_through_status','base_price','tcs_fee','gst_fee','pg_convenience_and_internet_fee'
    ];
