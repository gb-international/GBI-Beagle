...
{
    protected $fillable = ['user_id', 'edu_institute_id', 'itinerary_id','start_date','end_date','person','room','occupancy_type','noofday','accomodation','city','transport','sightseen', 'adults', 'children', 'infants'];
